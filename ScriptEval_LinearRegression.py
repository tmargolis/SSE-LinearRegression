...
class ScriptEval:
    ...
    def get_arguments(context, arg_types, duals):
        ...
        :return: list of numerical arguments
        """
    ...
    def get_return_type(header):
        """
        This plugin supports functionality for return type string, but no others.
        :param header:
        :return:
        """
